...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { name: @template.name, templatetype: @template.templatetype, text: @template.text } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { name: @template.name, templatetype: @template.templatetype, text: @template.text } }
