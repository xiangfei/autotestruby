...
class ConfigsTest < ApplicationSystemTestCase
  ...
  test "creating a Config" do
    ...
    fill_in "App", with: @config.app_id
    fill_in "Content", with: @config.content
    fill_in "Description", with: @config.description
    fill_in "Env", with: @config.env
    fill_in "Name", with: @config.name
